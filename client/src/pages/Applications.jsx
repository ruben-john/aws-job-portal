  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto p-6 lg:p-10">
        {/* Resume Section */}
        <section className="glass-card rounded-3xl p-8 mb-10">
          ...
          {isEdit ? (
            ...
            <div className="bg-white/60 p-6 rounded-2xl border border-white/60 shadow-sm">
              ...
              <div className="mt-6 flex gap-4 justify-end">
                <button
                  ...
                  className={`px-5 py-2 rounded-full font-medium transition cursor-pointer shadow-sm ${
                    isUploading
                ...
                <button
                  ...
                  disabled={isUploading}
                  className="bg-white/60 hover:bg-white/80 text-gray-700 font-medium px-5 py-2 rounded-full transition border border-gray-300/50 cursor-pointer shadow-sm hover:scale-105 active:scale-95"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="flex items-center justify-between">
                ...
                {userData?.resume ? (
                  <div className="flex items-center gap-4">
                    ...
                    <a
                      ...
                      className="px-4 py-2 bg-green-50 backdrop-blur-sm hover:bg-green-100 text-green-700 border border-green-200 rounded-full text-sm font-medium transition shadow-sm hover:scale-105"
                    >
                      View Resume
                    </a>
                  </div>
              ...
              <button
                ...
                className="btn-primary px-6 py-2 rounded-full cursor-pointer shadow-sm font-medium"
              >
